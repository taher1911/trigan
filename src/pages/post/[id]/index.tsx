                          ...
                          <div className="flex flex-col">
                            ...
                            <div className="flex w-[400px] flex-col gap-2 px-8 py-4">
                              ...
                              <p className="flex flex-wrap text-[16px] font-normal text-white">
                                ...
                                sed viverra amet est odio massa libero
                                scelerisque rhoncus. Condimentum est sit montes
                                nulla pharetra lacus neque faucibus. Vitae
                                vulputate ac vitae ac aenean. Erat pulvinar
                                pretium cras proin id interdum. Elit purus
                                tincidunt facilisis turpis tellus suspendisse.
